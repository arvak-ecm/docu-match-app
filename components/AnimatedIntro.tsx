...
const content = [
  {
    title: "Let's create.",
    bg: Colors.intro.lime,
    fontColor: Colors.intro.pink,
  },
  {
    title: "Let's brainstorm.",
    bg: Colors.intro.brown,
    fontColor: Colors.intro.sky,
  },
  {
    title: "Let's discover.",
    bg: Colors.intro.orange,
    fontColor: Colors.intro.blue,
  },
  {
    title: "Let's go.",
    bg: Colors.intro.teal,
    fontColor: Colors.intro.yellow,
  },
  {
    title: "ChatGPT.",
    bg: Colors.intro.green,
    fontColor: Colors.intro.pink,
  },
];
